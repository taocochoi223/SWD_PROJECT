...
namespace SWD.DAL.Migrations
{
    ...
    [Migration("20260319083640_UpdateAlertRuleWithType")]
    partial class UpdateAlertRuleWithType
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SWD.DAL.Models.SensorData", b =>
                {
                    ...
                    b.HasIndex(new[] { "HubId", "RecordedAt" }, "IDX_SensorData_Hub_Time");
            ...
            modelBuilder.Entity("SWD.DAL.Models.AlertRule", b =>
                {
                    ...
                    b.HasOne("SWD.DAL.Models.Organization", "Organization")
                        .WithMany("AlertRules")
                        .HasForeignKey("OrgId")
                        .IsRequired()
                        .HasConstraintName("FK_AlertRule_Organization");

                    b.HasOne("SWD.DAL.Models.SensorType", "SensorType")
                        .WithMany("AlertRules")
