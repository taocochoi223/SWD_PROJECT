...
namespace SWD.DAL.Repositories.Interfaces
{
    public interface IAlertRepository
    {
        ...
        Task<List<AlertRule>> GetAllRulesAsync(string? search, bool? isActive, string? priority, int? siteId = null, int? hubId = null, string? sortBy = null, string? sortOrder = "asc");
