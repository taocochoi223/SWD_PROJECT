...
namespace SWD.BLL.Interfaces
{
    public interface IAlertService
    {
        ...
        Task<(List<AlertRule> Rules, int TotalCount)> GetAllRulesAsync(string? search, bool? isActive, string? priority, int? siteId, int? hubId, int? pageNumber, int? pageSize, string? sortBy = null, string? sortOrder = "asc");
